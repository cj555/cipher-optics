...
var AUDIENCE = {
  ...
  // seed: realistic baseline usage count for percentage display
  taglines: {
    zh: [
      { text: '永不言败', seed: 847 },
      { text: '王者归来', seed: 744 },
    ...
    en: [
      { text: 'My Legend', seed: 712 },
      { text: 'Never Give Up', seed: 634 },
      { text: 'Born to Win', seed: 581 },
      { text: 'Champion', seed: 529 },
      { text: 'Glory Days', seed: 447 },
      { text: 'Field King', seed: 392 },
      { text: 'Fearless', seed: 368 },
      { text: 'Rise Up', seed: 341 },
      { text: 'All In', seed: 298 },
      { text: 'Born for This', seed: 263 },
    ],
    fr: [
      { text: 'Ma Légende', seed: 523 },
      { text: 'Sans Limite', seed: 478 },
      { text: 'Champion', seed: 445 },
      { text: 'Né Pour Gagner', seed: 389 },
      { text: 'Gloire Éternelle', seed: 312 },
      { text: 'Maître du Stade', seed: 287 },
      { text: 'Intrépide', seed: 264 },
      { text: 'En Avant', seed: 241 },
      { text: 'Tout Donner', seed: 198 },
      { text: 'Fait Pour Ça', seed: 176 },
    ],
    de: [
      { text: 'Meine Legende', seed: 498 },
      { text: 'Niemals Aufgeben', seed: 452 },
      { text: 'Champion', seed: 421 },
      { text: 'Zum Siegen Bereit', seed: 367 },
      { text: 'Furchtlos', seed: 298 },
      { text: 'Aufsteigen', seed: 276 },
      { text: 'Feldherr', seed: 243 },
      { text: 'Ruhm', seed: 215 },
      { text: 'Alles Geben', seed: 189 },
      { text: 'Dafür Geboren', seed: 162 },
    ],
  },
